...
router.post('/followUp', authController.restrictTo(enums.ROLE.DOCTOR,enums.ROLE.PATIENT),appointmentController.followUpAppointment);
router.patch('/reschedule/:id',authController.restrictTo(enums.ROLE.DOCTOR,enums.ROLE.PATIENT),appointmentController.rescheduleAppointment);
router.patch('/cancel/:id',authController.restrictTo(enums.ROLE.DOCTOR,enums.ROLE.PATIENT),appointmentController.cancelAppointment);

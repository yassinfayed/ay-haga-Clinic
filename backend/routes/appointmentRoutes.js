...
router.post('/followUp', auth.controller.restrictTo(enums.ROLE.DOCTOR,enums.ROLE.PATIENT),appointmentController.followUpAppointment);
router.patch('/reschedule/:id',auth.controller.restrictTo(enums.ROLE.DOCTOR,enums.ROLE.PATIENT),appointmentController.rescheduleAppointment);
router.patch('/cancel/:id',auth.controller.restrictTo(enums.ROLE.DOCTOR,enums.ROLE.PATIENT),appointmentController.cancelAppointment);
router.patch('/update/:id', appointmentController.updateAppointment);
router.post('/evaluateFollowUp/:id',authController.restrictTo(enums.ROLE.DOCTOR),appointmentController.evaluateFollowUp);

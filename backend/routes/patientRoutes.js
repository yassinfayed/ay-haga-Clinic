...
router.get(
  "/viewHealthPackageSubscription/:id",
  patientController.viewHealthPackageSubscription,
);

router.post(
  "/upload/healthRecords/:id",
  patientController.uploadHealthRecords.single("image"),
  patientController.postUploadHealth,
);
...
router.get(
  "/my-details",
  restrictTo(enums.ROLE.PATIENT),
  patientController.getMyDetails,
);

router.post(
  "/upload/medicalRecords",
  protect,
  patientController.uploadMedicineRecords.array("documents", 5),
  patientController.postUpload,
);

...
const Footer = () => {
  return (
    <footer className="bg-primary text-white pt-4 pb-1 mt-4">
      <div className="container">
        <div className="row">
            ...
            <ul className="list-unstyled ">
              ...
              <li>
                <a href="/services" className="text-white text-decoration-none">
                  <div className="link-hover">Services</div>
                </a>
              </li>
              <li>
                <a
          ...
          <div className="col-md-4 mx-3">
            ...
            <p>
              {" "}
              <Image src="/mail.svg" height={18} width={18} /> info@clinic.com
            </p>
            <p>
              {" "}
              <Image src="/location.svg" height={22} width={22} /> Clinic
              Address
            </p>
          </div>

  ...
  return (
    <div className='w-100'>
      ...
      <div className="page-div container justify-content-center align-items-center m-5 mx-auto">
        ...
        <p>
          At Vite, we take your privacy seriously. We collect and store personal information
        ...
        <p>
            Vite may use third-party services for certain functions, such as payment processing
        ...
        <p>
            Vite reserves the right to update this policy at any time. Users will be notified of

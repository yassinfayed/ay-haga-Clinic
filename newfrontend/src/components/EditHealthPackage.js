const { updateHealthPackage } = require("@/app/redux/actions/healthPackagesActions");
const { updateHealthPackageReducer } = require("@/app/redux/reducers/healthPackagesReducer");
const { Card, TextInput, Button } = require("@tremor/react");
const { useState, useEffect } = require("react");
const { useDispatch } = require("react-redux");

function EditHealthPackageModal({ children, visible, setVisible,data,setData,setId }) {
    console.log(data)
    ...
    return (
        ...
        >
            ...
            >
                ...
                setFormData(null)
                console.log(formData)
                setData(null)}} className="ms-auto">

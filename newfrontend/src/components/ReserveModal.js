      ...
      <div className="p-4 flex flex-col">
        ...
        <div className="w-full mt-2">
          <div className="flex w-full items-center justify-center">
            <div role="button" onClick={() => handleRecieverChange("me")} className="flex-1 flex-col grow flex items-center justify-center" style={{ filter: packageReciever === 'me' ? '' : 'brightness(0.3)' }}>
            ...
            <div role="button" onClick={() => handleRecieverChange("family")} className="flex-1 flex-col grow flex items-center justify-center" style={{ filter: packageReciever === 'family' ? '' : 'brightness(0.3)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-20 h-20">
        ...
        <div className="my-2 w-full text-center">
          ...
          <Select className="w-full mt-2" value={paymentMethod} onValueChange={handlePaymentChange}>
            <SelectItem icon={() => (
              <>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#357A59" className="w-6 h-6 mx-2">
            ...
            >
              Wallet (Available Balance: {JSON.parse(localStorage.getItem("userInfo")).data?.user.wallet} USD)
            </SelectItem>

            <SelectItem
              icon={() => (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#424874" className="w-6 h-6 mx-2">
        ...
        {packageReciever === 'family' &&
          <div className="my-4 w-full">
            ...
            <h1 className="text-gray-700 text-sm text-center">(Reserving Appointment For)</h1>
            <Select
        ...
        {health ? (
          <div className="flex flex-col w-full text-center">
            ...
            <p className="font-semibold">{(hourlyRate - hourlyRate * (health / 100)).toFixed(2)} USD</p>
          </div>
        ) : (
          <div className="flex flex-col w-full text-center">

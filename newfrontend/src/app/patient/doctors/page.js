...
import {
  ...
  import { DatePicker, DateRangePicker, Select, SelectItem, TextInput } from "@tremor/react";
...
setDoctorSelected(true)
  ...
  <Select
            ...
            className="flex-[2]"
            onChange={(e) => setSpeciality(e === "" ? {} : { "speciality": { "in": e } })}
          >
            <SelectItem value=''>
                    All
                  </SelectItem>
          ...
          <div className="flex overflow-hidden gap-x-4 gap-y-8">
            ...
            <> 
            <div role="button" onClick={() => setShowAvailabilty(false)} className="ms-auto">

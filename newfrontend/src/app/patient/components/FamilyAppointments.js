...
{cancelError &&
  ...
  />
   ...
   {!reschedule && <>
    ...
    {reschedule && 
    <Card className="flex flex-col w-64 h-96"> {/* Adjust the width and height as needed */}
      <div role="button" onClick={() => setReschedule(false)} className="ms-auto">
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"> {/* Adjust the width and height as needed */}

...
const Prescriptions = ({ params }) => {
  ...
  const [filledUnfilled, setFilledUnfilled] = useState(false);
  ...
  const handleSubmit = () => {
    const newPrescription = {
      ...
      medicines,
      instructions,
      filled_unfilled: filledUnfilled,
    }
    ...
    <>
      ...
      <div className="w-full flex flex-row gap-4 mb-4 divide-x divide-gray-400">
        ...
        <PrescriptionCard
          ...
          <AddPrescription isOpen={open} setIsOpen={setOpen} medicines={medicines} setMedicines={setMedicines} instructions={instructions} setInstructions={setInstructions} filledUnfilled={filledUnfilled} setFilledUnfilled={setFilledUnfilled} 

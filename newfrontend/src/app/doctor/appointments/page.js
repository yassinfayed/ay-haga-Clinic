...
import { cancelAction, rescheduleAction } from "@/app/redux/actions/appointmentActions";
...
[dispatch, selectedDate, selectedStatus, followuploading,rescheduleLoading,cancelLoading,revokeLoading]);
...
useEffect(()=>
{
if(!rescheduleLoading && appointment)
setRescheduleOpen(false)
...
{errorcancle &&
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                    ...
                    <path fillRule="evenodd" d="M5.47 5.47a.75.75 0 011.06 0L12 10.94l5.47-5.47a.75.75 0 111.06 1.06L13.06 12l5.47 5.47a.75.75 0 11-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 01-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 010-1.06z" clipRule="evenodd" />
                            ...
                            (appointment.followUp==="Accepted" ? (<span className='mx-10'>
                            Follow Up Scheduled

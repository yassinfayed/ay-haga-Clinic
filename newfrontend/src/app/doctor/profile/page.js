...
function DoctorProfile() {
  const id = JSON.parse(localStorage.getItem("userInfo"))?.data.user.doctor
    ?._id;
          ...
          <>
            ...
            <div numItems={3} className="flex flex-row gap-2">
              <Card>
                ...
                <div className="flex mt-[2rem]">
                  ...
                  <p className="ml-3 text-lg">{doctor?.name}</p>
                </div>
                ...
                <div className="flex mt-5">
                  ...
                  <p className="ml-3 text-lg">
                    {translateDate(new Date(doctor?.DateOfbirth))[0]}
                  </p>
                </div>
                <div className="flex mt-5">
                  <Image src="/wallet.svg" height={25} width={25}></Image>{" "}
                  <p className="ml-3 text-lg">{doctor?.user.wallet} USD</p>
                </div>
              </Card>
              <Card>
                <div className="flex">
                    ...
                    {!isEditEmployment ? (
                      ...
                      <>
                        ...
                        <div
                          className="ml-5"
                          role="button"
                          onClick={handleCancelEditEmployment}
                        >
                          <span className="">
                            <Image
                              src="/cross.svg"
                ...
                <div className="flex mt-[2rem]">
                  ...
                  <p className="ml-3 text-lg">{doctor?.speciality}</p>
                </div>
                <div className="flex mt-5">
                ...
                <div className="flex mt-5">
                  <Image src="/book.svg" height={25} width={25}></Image>{" "}
                  <p className="ml-3 text-lg">
            ...
            <Grid className="mt-2">
              <div>
                ...
                <hr />
                <br />
                <h1 className="text-3xl font-bold text-white-200">
                  My Available Slots
                </h1>
              </div>
